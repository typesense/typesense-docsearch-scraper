...
class TypesenseHelper:
    ...
    def add_records(self, records, url, from_sitemap):
        ...
        for i in range(0, record_count, 50):
            ...
            failed_items = list(
                map(lambda r: json.loads(json.loads(r)), filter(lambda r: json.loads(json.loads(r))['success'] is False, result)))
    ...
    def transform_record(record):
        ...
        transformed_record['item_priority'] = transformed_record.get('item_priority', 10)
